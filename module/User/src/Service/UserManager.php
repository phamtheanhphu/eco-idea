...
class UserManager {
    ...
    public function addUser($data) {
        ...
        //get assigned group
        $assigned_group = $this->entityManager->getRepository(Group::class)
            ->find($data['group']);

        //assign user to group
        if ($assigned_group instanceof Group) {

            //clear all current assgined groups
            $user->getGroups()->clear();

            //add to new group
            $user->addToGroup($assigned_group);
    ...
    public function changePasswordByAdmin($user, $data) {

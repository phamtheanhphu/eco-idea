...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'fullName', 'password', 'date_created', 'status', 'groups', 'devices', 'password_reset_token', 'pwd_reset_token_creation_date'];
        }
    ...
    public function getFirstGroup()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFirstGroup', []);

        return parent::getFirstGroup();
    }
